...
Skullboard is essentially a reskinned starboard, if you know what that is. If you don't, it's basically meant to forward the memorable, to a channel. Skullboard is just for when its stupid and out of context and you want to frame it.
